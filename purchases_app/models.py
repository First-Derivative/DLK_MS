...
class Purchases(models.Model):
  ...
  purchase_order = models.CharField(null=True, verbose_name="Purchase Order Number",max_length=20)
  ...
  currency = models.CharField(null=True, max_length=10, choices=Currency.choices, default=Currency.MYR)
